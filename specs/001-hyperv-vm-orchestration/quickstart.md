...
ragnatramp halt ragnatramp.yaml
...
ragnatramp destroy ragnatramp.yaml
```
...
- Read the [Configuration Reference](./docs/config-reference.md) for all YAML options
- Read the [Command Reference](./docs/commands.md) for detailed command documentation
